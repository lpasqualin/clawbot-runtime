...
import { a as normalizeTelegramChatId, o as normalizeTelegramLookupTarget, s as parseTelegramTarget, t as normalizeTelegramReplyToMessageId } from "./outbound-params-DGwD1V0i.js";
import { a as makeProxyFetch, n as resolveTelegramFetch } from "./fetch-CQWpZY-X.js";
import { t as resolveTelegramPreviewStreamMode } from "./preview-streaming-BJiwhNvI.js";
import { loadCronStore, readConfigFileSnapshotForWrite, requireRuntimeConfig, resolveCronStorePath, resolveMarkdownTableMode, resolveStorePath, saveCronStore, writeConfigFile } from "openclaw/plugin-sdk/config-runtime";
...
import { buildOutboundMediaLoadOptions as buildOutboundMediaLoadOptions$1, getImageMetadata, isGifMedia as isGifMedia$1, isVoiceCompatibleAudio, kindFromMime as kindFromMime$1, normalizePollInput } from "openclaw/plugin-sdk/media-runtime";
...
function describeReplyTarget(msg) {
	...
	const rawQuoteText = msg.quote?.text ?? externalReply?.quote?.text;
	...
	if (!body && replyLike) {
		const rawReplyText = typeof replyLike.text === "string" ? replyLike.text : typeof replyLike.caption === "string" ? replyLike.caption : void 0;
...
//#endregion
export { getTelegramTextParts as $, tagTelegramNetworkError as A, resetTelegramForumFlagCacheForTest as B, markdownToTelegramHtmlChunks as C, isSafeToRetrySendError as D, isRecoverableTelegramNetworkError as E, buildTelegramRoutingTarget as F, resolveTelegramReplyId as G, resolveTelegramForumFlag as H, buildTelegramThreadParams as I, withResolvedTelegramForumFlag as J, resolveTelegramStreamMode as K, buildTypingThreadParams as L, buildTelegramGroupFrom as M, buildTelegramGroupPeerId as N, isTelegramClientRejection as O, buildTelegramParentPeer as P, extractTelegramLocation as Q, describeReplyTarget as R, markdownToTelegramHtml as S, wrapFileReferencesInHtml as T, resolveTelegramForumThreadId as U, resolveTelegramDirectPeerId as V, resolveTelegramGroupAllowFromContext as W, buildSenderName as X, buildSenderLabel as Y, expandTextLinks as Z, wasSentByBot as _, editMessageTelegram as a, firstDefined as at, withTelegramApiErrorLogging as b, renameForumTopicTelegram as c, normalizeDmAllowFromWithStore as ct, sendStickerTelegram as d, hasBotMention as et, sendTypingTelegram as f, recordSentMessage as g, resolveTelegramVoiceSend as h, editMessageReplyMarkupTelegram as i, resolveTelegramPrimaryMedia as it, buildGroupLabel as j, isTelegramPollingNetworkError as k, sendMessageTelegram as l, resolveSenderAllowMatch as lt, unpinMessageTelegram as m, deleteMessageTelegram as n, normalizeForwardedContext as nt, pinMessageTelegram as o, isSenderAllowed as ot, send_exports as p, resolveTelegramThreadSpec as q, editForumTopicTelegram as r, resolveTelegramMediaPlaceholder as rt, reactMessageTelegram as s, normalizeAllowFrom as st, createForumTopicTelegram as t, isBinaryContent as tt, sendPollTelegram as u, buildInlineKeyboard as v, renderTelegramHtmlText as w, markdownToTelegramChunks as x, splitTelegramCaption as y, extractTelegramForumFlag as z };
