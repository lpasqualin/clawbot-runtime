...
import { j as createDiscordRestClient } from "./send.shared-G5HPu1EM.js";
import { s as createThreadDiscord } from "./send-C92oy8jh.js";
import { a as sendWebhookMessageDiscord, t as sendMessageDiscord } from "./send.outbound-BTnNj5k_.js";
import { i as REUSABLE_WEBHOOKS_BY_ACCOUNT_CHANNEL, k as toReusableWebhookKey, m as rememberReusableWebhook, t as BINDINGS_BY_THREAD_ID } from "./thread-bindings.state-DuxVx5Uu.js";
...
async function resolveChannelIdForBinding(params) {
	...
	try {
		const channel = await createDiscordRestClient({
			...
			accountId: params.accountId,
			token: params.token
		}).rest.get(Routes.channel(lookupThreadId));
